					...
					<tbody>
							<tr>
								...
								for ( $i = 9; $i >= 0; $i-- ) {
								 ...
								 {
									$x=ord('a')+$i-1;
									$style='gray;height:40px;width:40px;font-size:10px';
								 }
								 if($i==0){
								  $x=ord('x');
									$style='gray;height:10px;width:40px;font-size:10px';
						...
						<?php $rownum=0; for ( $i = sizeof($graphical_board_array)-1; $i >= 0; $i-- ) {
							...
							<tr>
								 <?php  $position='l';
										echo '<td 	name="'.$position.$rownum.'" id ='.$position.$rownum.' class="truce" style="height:10px;width:40px;background-color:gray;font-size:10px">
