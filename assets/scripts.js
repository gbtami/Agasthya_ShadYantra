	...
	if ((($("div.status_box").attr('id')=='1')&& (p1name.match(/^[A-ZÁ]*$/))) || (($("div.status_box").attr('id')=='2')&& (p1name.match(/^[a-zá]*$/)))) {
		...
		if(color_to_move!=''){
			...
			if(naaradmove==true){
				...
				//if($("input#"+color_to_move+"officerscanmovefull").val()=='0')
				$("textarea#player2ta").val($("textarea#player2ta").val()+"\n*N01# 'N' can push Opponent Army Officials in Truce-Zone, provided the Army Official is in touch with their own I/A/C/G but these I/A/G are not touching the 'N'. 'N' is not impacted by 'S'.");
				}
